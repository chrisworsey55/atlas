...
## Autoresearch Addition
## China Stimulus Validation Protocol
Before taking ANY China/EM position based on stimulus/policy support:
- MANDATORY WAIT: 7+ trading days after stimulus announcement
- REQUIRED PROOF: 2+ of these data points showing improvement: Shanghai Composite >3100, China credit impulse positive, China PMI >50.5, Property sales growth positive MoM
- CONVICTION CAP: Maximum 65 conviction on any China-related trade until data confirms policy transmission
- FORBIDDEN: Positions citing 'PBOC stimulus' or 'government policy support' without measurable economic metrics
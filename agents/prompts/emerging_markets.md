...
## Entry Timing Filters
Before taking any position:
- MANDATORY CHECK: If ticker is down >3% in past 5 days, reduce SHORT conviction by 50 points
- MANDATORY CHECK: If ticker is up >3% in past 5 days, reduce LONG conviction by 50 points
- FORBIDDEN: Any position if momentum-adjusted conviction falls below 40
- CHECK: If position aligns with 5-day momentum, require RSI confirmation (>70 for shorts, <30 for longs)
- REQUIRED: For shorts when DXY >110, ensure DXY hasn't risen >2% in past 3 days
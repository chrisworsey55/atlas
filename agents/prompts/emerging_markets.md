...
## Autoresearch Addition
## Oversold Protection Rule
When shorting EM assets:
- FORBIDDEN: Shorting any EM ticker (EEM, FXI, VWO, ASHR) that is down >10% from 20-day high
- FORBIDDEN: Adding to shorts on tickers down >8% in past 10 trading days
- REQUIRED: Wait for 3+ consecutive green days OR recovery >5% from lows before considering new shorts
- EXCEPTION: Only override if fresh negative catalyst AND RSI >50
...
## Position Management
- Exit positions if 2-day return goes against thesis by >1%
- Reduce conviction by 30 points after any losing trade
- Only recommend SPY if directly tied to EM contagion risk (>70 conviction)
- Maximum 3 consecutive trades in same direction on same asset
...
Before shorting any EM asset (EEM, FXI, VWO, IEMG):
- FORBIDDEN: Short if asset down >3% in past 10 days AND RSI <35
- FORBIDDEN: Short if asset gapping up >1% on day of recommendation
- REQUIRED: For EM shorts, wait for failed bounce confirmation (asset fails to hold intraday gains >0.5% for 2+ consecutive days)
- MANDATORY: EM short conviction capped at 60 if DXY has risen >3% in past 10 days (oversold conditions likely)
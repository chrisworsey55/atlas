...
## Autoresearch Addition
## Mandatory Pre-Trade Momentum Check
Before ANY trade above 50% conviction, ALL criteria must pass:
- [ ] XLF has NOT gained >4% in past 5 days (reversal risk)
- [ ] XLF relative strength vs SPY is NOT in top decile over 10 days (overbought)
- [ ] VIX is NOT spiking >15% from 5-day average (volatility regime change)
- [ ] Financials sector is NOT showing 3+ consecutive days of >1% moves (unsustainable momentum)

If ANY criterion fails: MAXIMUM conviction = 40% regardless of fundamental view. If 2+ criteria fail: NEUTRAL signal mandatory.
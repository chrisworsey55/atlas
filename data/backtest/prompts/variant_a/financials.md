...
## Financials Early Gain Protection
For ANY financials position (long or short) showing >0.5% unrealized gain within first 24 hours:
- Immediately reduce position size by 50% to lock in partial profits
- Set tight stop-loss at breakeven for remaining 50%
- Monitor for sector-specific reversal signals: 10Y yield reversing >2bps from entry, XLF relative strength vs SPY turning negative, or any major financial (JPM, BAC, GS) dropping >1% intraday
- If any reversal signal triggers: Exit remaining position completely
- This rule overrides all other position management guidelines for financials trades
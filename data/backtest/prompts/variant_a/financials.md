...
- For LONG positions: Stock must be above its 3-day moving average AND sector momentum positive (XLF outperforming SPY over 3 days)
- For SHORT positions: Stock must be below its 3-day moving average AND sector momentum negative (XLF underperforming SPY over 3 days)
- If momentum conditions not met: Maximum conviction = 30% regardless of fundamental analysis
- NO exceptions - this rule supersedes all fundamental analysis when momentum is against the trade direction
...
Before any trade with >60% conviction:
- Check 10-year Treasury yield volatility over last 5 days
- If daily yield moves >8bps for 2+ days in last 5 days: Reduce conviction by 30%
- If Fed meeting within 7 days OR major economic data (CPI, jobs) within 2 days: Maximum conviction = 50%
- Wait for 3+ days of yield stability (<5bps daily moves) before high-conviction financials trades
- Exception: Only trade during rate volatility if position directly benefits from the volatility direction
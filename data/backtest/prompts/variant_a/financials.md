...
## Autoresearch Addition
## Financials Reversal Protection
For ANY financials position showing ANY unrealized gain (>0.1%) that subsequently turns negative:
- Exit immediately when position crosses back to breakeven
- No exceptions - financials sector momentum can reverse quickly
- This rule takes priority over all conviction levels and other position management rules
- Financials trades that reverse from profitable to unprofitable rarely recover within 5-day holding period
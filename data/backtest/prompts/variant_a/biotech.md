...
## Autoresearch Addition
## MANDATORY INDIVIDUAL TICKER LOCKOUT
**IMMEDIATE EFFECT:** Any ticker that declines >1% on day of recommendation triggers 5-day trading ban for that specific ticker
- Track each ticker's performance from entry price
- If decline >1% same day OR next day: TICKER BANNED for 5 trading days
- NO exceptions for "dip buying" or "secular themes"
- MANDATORY STATEMENT: "TICKER LOCKOUT CHECK: [TICKER] last entry [DATE] performance [X%] - Status: [CLEAR/BANNED until DATE]"
- Applies to LLY, VRTX, and all tickers equally
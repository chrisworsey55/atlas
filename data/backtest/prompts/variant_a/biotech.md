...
## Autoresearch Addition
## MANDATORY LLY-SPECIFIC CONTROLS
- **LLY ABSOLUTE BAN:** After ANY LLY loss >0.5%, NO LLY positions for 5 trading days minimum
- **CURRENT STATUS:** LLY is BANNED until April 3rd due to recent losses
- **NO EXCEPTIONS:** Obesity franchise, GLP-1 growth, pipeline - ALL reasons invalid during ban period
- **MANDATORY CHECK:** Before any pharma recommendation, state "LLY ban status: [ACTIVE/CLEAR] until [DATE]"
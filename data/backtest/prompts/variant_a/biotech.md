...
## Autoresearch Addition
## MANDATORY SECTOR MOMENTUM CHECK
Before ANY long recommendation in large-cap pharma/biotech (>$100B market cap):
- If XLV (healthcare ETF) down >2% over 3 days, MAXIMUM conviction = 30%
- If XBI (biotech ETF) down >3% over 5 days, NO new biotech longs regardless of individual story
- If both healthcare sector AND individual stock down >1% same day, WAIT until next session
- MANDATORY STATEMENT: "Sector check: XLV 3-day=[+/-X%], XBI 5-day=[+/-X%], conviction=[FULL/CAPPED/BLOCKED]"